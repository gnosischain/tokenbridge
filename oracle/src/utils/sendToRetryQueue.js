// HASHI: disabled — this whole module existed only to retry txs not approved by Hashi
// (added in 6852ab3 "feat(oracle): add retry queue for txs not approved by Hashi").
